 ...
 ***
*/
$title = 'Encode Line Breaks';

$sample = "Make a single
line of this text.";
$input_placeholder = $sample;
$output_placeholder = print_r(json_encode($sample),true);

if (isset($_POST['content'])) {
    $result = !empty($_POST['content']) ? print_r(json_encode($_POST['content']), true) : $output_placeholder;
} else {
    $result = '';
}
